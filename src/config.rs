...
macro_rules! gen_skip_if_default {
    ($field: ident, $type: ty) => {
        paste::item! {
            ...
            ///
            /// If default value is set and Config.serialize_defaults is false then it will not be serialized
            ///
...
pub struct Cli {
    ...
    /// Print current configuration as YAML - useful for creating new configuration file
